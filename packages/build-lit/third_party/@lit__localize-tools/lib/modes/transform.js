 ...
 */
function tagLit(factory, template) {
    return factory.createTaggedTemplateExpression(factory.createIdentifier('html'), undefined, template);
}
/**
 ...
 * TemplateSpan.
 */
function makeTemplateLiteral(factory, fragments) {
    let textBuf = [];
    const spans = [];
    ...
    return factory.createTemplateExpression(factory.createTemplateHead(textBuf.join('')), spans);
}
